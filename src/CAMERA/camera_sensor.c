...
uint32_t g_plck_hz = RESET_VALUE;//plck_hz is the global variable to the camera sensor pixel clock frequency,and the value will be updated after the camera sensor is initialzed successfully.
...
static sensor_reg_t ov5640_mipi[] = //define the register array to initialize the camera sensor
{
 /* Power down */
...
sensor_reg_t live_camera[] = //define the register array to set the camera sensor to live camera mode
{
